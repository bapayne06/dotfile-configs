...
(custom-set-variables
 ...
 '(display-time-mode t)
 '(ede-project-directories '("/home/bpayne/programs/cpp/custom_shell"))
 '(ede-simple-save-directory "~/.emacs.d/simple-saves")
 '(erc-email-userid "bpayne88@protonmail.com")
 '(erc-modules
   '(autoaway autojoin button completion fill irccontrols list match menu move-to-prompt netsplit networks noncommands readonly replace ring sasl stamp track))
 '(erc-nick "togon")
 '(erc-nick-uniquifier "1")
 '(erc-port 6697)
 '(erc-sasl-auth-source-function 'erc-auth-source-search)
 '(erc-sasl-password "YRD8yXSd00YK")
 '(erc-send-whitespace-lines nil)
 '(erc-server "na.irc.esper.net")
 '(erc-system-name "@binux")
 ...
 '(indent-bars-color '("gray60" :face-bg t :blend 0.325))
 '(indent-bars-depth-update-delay 0.2)
 '(indent-bars-display-on-blank-lines nil)
 '(indent-bars-no-stipple-char-font-weight 'semi-bold)
 '(indent-bars-pattern " .")
 ...
 '(ispell-grep-options "-zU")
 '(ispell-highlight-p t)
 '(ispell-personal-dictionary "~/.emacs.d/.aspell_lang_pws")
 ...
 '(mm-external-terminal-program '("alacritty" "terminal" "xterm" "-e"))
